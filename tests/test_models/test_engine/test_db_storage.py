...
class TestDBStorageDocs(unittest.TestCase):
    # testing to check the documentation and style of DBStorage clas
    @classmethod
    def setUpClass(cls):
        cls.dbs_f = inspect.getmembers(DBStorage, inspect.isfunction)
...
test_db_storage.py'])
    ...
    def test_db_storage_module_docstring(self):
        # testing for the db_storage.py module docstring
    ...
    def test_db_storage_class_docstring(self):
        # testing for the DBStorage class docstring
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_all_no_class(self):
        """t esting that all returns all rows when no class is passed"""
